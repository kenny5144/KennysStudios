...
const About = () => {
  return (
    <>
      ...
      <div className="flex mt-10 md:h-[80vh] lg:h-screen  m m-auto items-center ">
        <div className="flex flex-col items-center">
            ...
            <div className="ml-2 flex  items-center">
              <section>
                ...
                <p className="md:w-46 md:ml-2 leading-relaxed mt-8">
                  ...
                  moments that make life so beautiful. Whether I'm photographing
                  a portrait or an event, I'm always on the lookout for that
                  magical instant when everything comes together. I believe in
          ...
          <div className="mt-4 md:mt-10 h-20 w-full md:w-fit p-2 flex justify-center rounded-lg m-auto items-center">
            ...
            >
              ...
              <p className="items-center md:mt-1 text-xl md:text-3xl">
